...
// isset:function used to determine whether a variable is set and is not null
if(isset($_POST['regs']))
{
    $fname=mysqli_real_escape_string($con,$_POST['fname']);
    $lname=mysqli_real_escape_string($con,$_POST['lname']);
    $email=mysqli_real_escape_string($con,$_POST['email']);
    $lic=mysqli_real_escape_string($con,$_POST['lic']);//licence
    $ph=mysqli_real_escape_string($con,$_POST['ph']);//phone
    $pass=mysqli_real_escape_string($con,$_POST['pass']);
    $cpass=mysqli_real_escape_string($con,$_POST['cpass']);
    $gender=mysqli_real_escape_string($con,$_POST['gender']);
    $Pass=md5($pass); //md5 for increption 
...
.invalid:before {
 ...
 <div class="main">
        ...
        <form id="register" action="register.php" method="POST">    
            ...
            <!--title: user shoud continue as example -->
...
myInput.onkeyup = function() {
  ...
  //global search :for search in all letters from a-z
...
<script>
    function onlyNumberKey(evt) {
        ...
        //cheak it is not space or letters    48 represent 0  and 57 represent  9
